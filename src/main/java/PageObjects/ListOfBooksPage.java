...
public class ListOfBooksPage extends BaseClassFMS {
    ...
    public ListOfBooksPage() throws InterruptedException {
    ...
    public boolean isToolTipDisplayed(WebElement element, String message){
